...
\section{問題２：線形回帰モデル (30\%)}\label{section-1}}
...
2.6
今まで計算した傾きと切片の数字を用いて，年齢と体重の関係を線形と考える場合の計算式を記入せよ．傾きと切片の計算結果の意味をそれぞれ記述せよ．(10\%)
...
2.8
重回帰線形モデルの計算結果を用いて，体重の平均値を年齢と性別の線形モデルで表示せよ．各回帰係数の意味を説明せよ．(15\%)
...
\section{問題４：生存分析 (10\%)}\label{section-2}}
