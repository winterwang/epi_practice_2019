...
- \usepackage{thmtools}
- \usepackage{verbatim}
# - \usepackage[fontfamily = helvetica]{fancyvrb}
- \usepackage{xltxtra}
- \XeTeXlinebreaklocale "ja"
- \XeTeXlinebreakskip=0pt plus 1pt
- \XeTeXlinebreakpenalty=0
- \setmainfont[Scale = 0.9]{IPAexMincho}
# - \setsansfont[Scale = 0.8]{Microsoft Sans Serif}
...
- (intercept/切片) の `-3.689` は”視力正常”群の対数オッズであることが確認できる；
