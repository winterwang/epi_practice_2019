...
\paragraph{ステップ２ --- ロジスティクスモデルを作る}\label{section-40}}
...
\subsection{年齢の影響を見る}\label{section-41}}
...
(年齢が15-34歳群の0.01から年齢が65歳以上群の0.84に上げた)．しかし，年齢の上昇と共に，死亡のオッズも上がる．年齢はここで，\underline{交絡因子 (confounder) }と定義される．
...
\hypertarget{ezr-2}{%
\subsubsection{EZRで年齢を調整したロジスティクス回帰モデルを作る}\label{ezr-2}}

\newpage
\vfill

\hypertarget{section-43}{%
\section{問題４：生存分析}\label{section-43}}

\newpage
\vfill

\hypertarget{section-44}{%
\section{参考図書：}\label{section-44}}
