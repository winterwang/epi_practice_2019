...
\item
  ...
  と同じ検定方法を使えるかどうかを判断するにはどの検定方法を使えばよいかを説明せよ．実際にこの検定方法を行ってください．
\end{enumerate}
...
\begin{center}\includegraphics[width=0.8\linewidth]{pic/lm05cut} \end{center}
...
\hypertarget{-}{%
\paragraph{ステップ２ --- ロジスティックモデルを作る}\label{-}}
