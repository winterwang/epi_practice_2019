...
\subsection{答え (回答用紙へ)}\label{section-1}}
...
\subsection{答え (回答用紙へ)}\label{section-2}}
...
\subsection{答え (回答用紙へ)}\label{section-3}}
...
\section{問題２：線形回帰モデル (30\%)}\label{section-4}}
...
\subsubsection{答え (回答用紙へ)}\label{section-16}}
...
\paragraph{ステップ２}\label{section-31}}
...
\subsubsection{答え (回答用紙へ)}\label{section-37}}
...
\subsubsection{視覚障害と死亡の関係を示すテーブルのデータをもとに，下表を完成せよ：}\label{section-38}}
...
\paragraph{答え (回答用紙へ)}\label{section-44}}
...
\paragraph{答え (回答用紙へ)}\label{section-47}}
...
\subsubsection{答え (回答用紙へ)}\label{section-48}}
